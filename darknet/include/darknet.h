...
extern int bbox_detection_count[10];
extern char* marker[10];
extern char* tag[10];
extern int max_bbox;
...
image load_image_heimdall(char *filename, int w, int h, int c, float final_bounding_boxes[6], char* shape, char* direction, int width, int height);
image load_image_color_heimdall(char *filename, int w, int h, float final_bounding_boxes[6], char* shape, char* direction, int width, int height);
