...
var home_component_1 = require('../login/login.component');
var todo_component_1 = require('../login/todo.component');
var todo_service_1 = require('../services/todo.service');
var msal_service_1 = require('../services/msal.service');
var routes = [
    { path: '', redirectTo: '/login', pathMatch: 'full' },
    { path: 'login', component: home_component_1.LoginComponent },
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                home_component_1.LoginComponent,
            ...
            bootstrap: [home_component_1.LoginComponent]
        }), 
