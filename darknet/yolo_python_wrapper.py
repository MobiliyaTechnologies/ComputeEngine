...
_load_yolo_model = mylib.load_yolo_model
_load_yolo_model.argtypes = (ctypes.c_char_p, ctypes.c_char_p)
...
_test_detector.argtypes = (ctypes.c_char_p, ctypes.c_char_p, ctypes.c_float, ctypes.c_float)
_test_detector.restype = None

def test_detector(datacfg, watchFolder, thresh, hier_thresh):
#	_load_yolo_model(cfgfile, weightfile)
	_test_detector(datacfg, watchFolder, thresh, hier_thresh)

def load_yolo_model(cfgfile, weightfile):
	_load_yolo_model(cfgfile, weightfile)
...
if __name__ == '__main__':
	...
	load_yolo_model(b'cfg/yolo.cfg', b'yolo.weights')
	run_detector("/home/ubuntu/darknet/cam/")
